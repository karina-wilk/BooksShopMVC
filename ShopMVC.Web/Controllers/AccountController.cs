...
namespace ShopMVC.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private IShoppingCartItemService shoppingCartService;

        public AccountController()
        {
            shoppingCartService = new ShoppingCartItemService();
        }
            ...
            else
            {
                ...
                switch (result)
                {
                    case SignInStatus.Success:
                        {
                            var shoppingCartItems = await shoppingCartService.GetList(user.Id);
